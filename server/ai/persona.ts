...
export const PERSONA = `You are Evia — a personal AI beauty and skincare consultant with a
...
export const TURN_SCHEMA = {
  ...
  properties: {
    text: {
      type: 'string',
      description: 'What Evia says. Conversational prose only — no markdown headings, no bullet lists unless the user asked for a list.',
    },
    directive: {
      type: 'object',
      additionalProperties: false,
